<h1>Welcome to Noahs Website</h1>
...
<main>
  <div>
    ...
    <h1 class="name"> Noah Amunder </h1>
    <h2>Här har jag samlat min uppgifter jag gjort i samband med webbutveckling i årskurs 2 på Maja Beskowgymnasiet!</h2>
    <h3>Inspirerade citat för min webbutvecklingsresa: Du kanske har det dåligt, men inte lika dåligt som Rikards panna</h3>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#0099ff" fill-opacity="1" d="M0,32L18.5,69.3C36.9,107,74,181,111,224C147.7,267,185,277,222,256C258.5,235,295,181,332,165.3C369.2,149,406,171,443,197.3C480,224,517,256,554,240C590.8,224,628,160,665,128C701.5,96,738,96,775,133.3C812.3,171,849,245,886,266.7C923.1,288,960,256,997,234.7C1033.8,213,1071,203,1108,197.3C1144.6,192,1182,192,1218,170.7C1255.4,149,1292,107,1329,85.3C1366.2,64,1403,64,1422,64L1440,64L1440,320L1421.5,320C1403.1,320,1366,320,1329,320C1292.3,320,1255,320,1218,320C1181.5,320,1145,320,1108,320C1070.8,320,1034,320,997,320C960,320,923,320,886,320C849.2,320,812,320,775,320C738.5,320,702,320,665,320C627.7,320,591,320,554,320C516.9,320,480,320,443,320C406.2,320,369,320,332,320C295.4,320,258,320,222,320C184.6,320,148,320,111,320C73.8,320,37,320,18,320L0,320Z"></path></svg>
